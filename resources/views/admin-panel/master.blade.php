                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    @if (Auth::user()->employer)                    
                        @if (Auth::user()->employer->status == 'registered')
                            <li class="nav-item">
                                <a href="{{ url('/employer/payment') }}" class="nav-link ">
                        ...
                        @endif
                        @if (Auth::user()->employer->status == 'employer')
                            <li class="nav-item">
                                <a href="{{ url('/employer') }}" class="nav-link ">
                                <i class="nav-icon fas fa-tachometer-alt"></i>
                                <p>
                                    Dashboard
                                </p>
                    ...
                    @elseif (Auth::user()->status == 'admin')     
                        ...
                        <li class="nav-item">
                            <a href="{{ url('/admin/payment') }}" class="nav-link ">
                                <i class="fa-regular fa-credit-card px-2"></i>
                            <p>
                                Payment
                            </p>
                            </a>
